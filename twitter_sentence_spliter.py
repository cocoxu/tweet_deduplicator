...
"""
twitter_sentence_spliter.py  -- a script for sentence spliting and redundancy removal for Twitter 


To run this code, you will also need to download the following tokenizer:
https://github.com/myleott/ark-twokenize-py/blob/master/twokenize.py


(1) Wei Xu wrote the original version in Python for her phd thesis work:
